...
def get_errors(image):
    ...
    prompt = [
        ...
        Return a bounding box for each of the section of math in this image. Include any mistakes about the math in these sections, if no mistakes just have an empty string
        """, 
        image,
        """
